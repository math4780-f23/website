---
title: "Multiple Linear Regression `r emo::ji('coder')`"
...
```{r}
#| out-width: 49%
knitr::include_graphics("./images/05-mlr/mlr_data_matrix.png")
```
...
- Suppose that for a model with 3 predictors, $SS_{res} = 90$, $SS_T = 245$, and $n = 15$.
$$R^2_{adj} = 1 - \frac{90/(15-4)}{245/(15-1)} = 0.53$$
- Now suppose that the 4-th regressor is added into the model, and $SS_{res} = 88$ (always decreases). Then
