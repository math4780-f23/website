...
3. Install the R package `IRLR2`. Choose a continuous variable in the `IRLR2::Boston` data set. Use the `sample()` function to draw a simple random sample of size 20 from this population. Calculate the sample average.
